export const ukTranslations = {
  ...
  profilePage: {
    ...
    statFavorites: "Збережені",
    statApplications: "Відгуки",
    statSearches: "Пошуки",
    ...
    goFavorites: "Відкрити збережені",
    goMessages: "Відкрити повідомлення",
    goSettings: "Відкрити налаштування",
    preferencesTitle: "Параметри",
    openToWorkTitle: "Відкритий до пропозицій",
    compactModeTitle: "Компактний режим",
